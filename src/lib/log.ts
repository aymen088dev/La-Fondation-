/**
 * Logging unifié OpenMontage basé sur @bedrock-oss/bedrock-boost.
 *
...
export const log = Logger.getLogger("OpenMontage");

/** Logger de la base de données (tag "db"). */
export const logDb = Logger.getLogger("OpenMontage", "db");

/** Logger des territoires (tag "territories"). */
export const logTerr = Logger.getLogger("OpenMontage", "territories");

/** Logger de la modération (tag "moderation"). */
export const logMod = Logger.getLogger("OpenMontage", "moderation");

/** Logger des permissions/rôles (tag "permissions"). */
export const logPerm = Logger.getLogger("OpenMontage", "permissions");
