...
- `world_behavior_packs.json` → BP `2915bab9-50f2-442e-a17a-4c8e9cd688fb` v1.1.0
- `world_resource_packs.json` → RP `33ca6e1c-4f30-46ae-8b56-1510382e3f61` v1.1.0
...
1. Incrémente `version` dans `BP/manifest.json` ET `RP/manifest.json` (ex : 1.1.0 → 1.2.0)
2. Reporte la même version dans `serveur/world_behavior_packs.json` et `serveur/world_resource_packs.json`
